                ...
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center logo-container">
                        <Link :href="route('home')" as="button">
                            <BreezeApplicationLogo class="nav-logo block h-8 w-auto fill-current text-gray-600" />
                    ...
                    <div class="ml-3 relative">
                        <BreezeDropdown align="right" width="48">
                            ...
                            <template #content v-else>
                                <BreezeDropdownLink :href="route('login')" as="button">
                                    Log In
                                </BreezeDropdownLink>
                                <BreezeDropdownLink :href="route('register')" as="button">
                                    Register
                                </BreezeDropdownLink>
                            </template>
        ...
        <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1" v-else>
                    <BreezeResponsiveNavLink :href="route('login')" as="button">
                        Log In
                    </BreezeResponsiveNavLink>

                    <BreezeResponsiveNavLink :href="route('register')" as="button">
                        Register
                    </BreezeResponsiveNavLink>
                </div>
